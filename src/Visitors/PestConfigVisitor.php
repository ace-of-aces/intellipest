...
use AceOfAces\IntelliPest\Support\ExpectationSignatureExtractor;
use PhpParser\Node;
...
final class PestConfigVisitor extends NodeVisitorAbstract
{
    ...
    public function __construct(
        ...
        private readonly ExpectationSignatureExtractor $signatureExtractor = new ExpectationSignatureExtractor,
    ) {}
    ...
    private function processExpectChain(array $methods): void
    {
        foreach ($methods as $method) {
            ...
            if ($name !== null) {
                [$parameters, $returnType] = $this->signatureExtractor->extract($method['args']);
